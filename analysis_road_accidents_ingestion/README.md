# analysis_road_accidents_ingestion

The 'analysis_road_accidents_ingestion' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/analysis_road_accidents_ingestion/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] analysis_road_accidents_ingestion_etl` to your workspace.
